...
import 'package:Mazaj/screens/feed/userpostc.dart';
...
class UserProfileC extends StatefulWidget {
  final String username;
  const UserProfileC(this.username, {Key? key}) : super(key: key);

  @override
  _UserProfileCState createState() => _UserProfileCState();
}

class _UserProfileCState extends State<UserProfileC> {
  List<Post>? posts;
            ...
            sliver: SliverGrid(
              ...
              delegate:
                ...
                return Container(
                  ...
                  child: UserPostC(postobj, _loggeduser),
                );
