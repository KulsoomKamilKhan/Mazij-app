...
class UserProfileM extends StatefulWidget {
  final String username;
  const UserProfileM(this.username, {Key? key}) : super(key: key);

  @override
  _UserProfileMState createState() => _UserProfileMState();
}

class _UserProfileMState extends State<UserProfileM> {
  List<Post>? posts;
            ...
            sliver: SliverGrid(
              ...
              delegate:
                ...
                return Container(
                  ...
                  child: UserPostM(postobj, _loggeduser),
                );
