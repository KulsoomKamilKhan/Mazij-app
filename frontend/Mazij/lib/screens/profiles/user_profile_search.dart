...
import 'package:Mazaj/screens/profiles/user_post_search.dart';
import 'package:Mazaj/screens/search/userpostsearch.dart';
...
class UserProfileSP extends StatefulWidget {
  ...
  @override
  _UserProfileSPState createState() => _UserProfileSPState();
}
            ...
            sliver: SliverGrid(
              ...
              delegate:
                ...
                return Container(
                  ...
                  child: UserPostSP(postobj, _loggeduser),
                );
